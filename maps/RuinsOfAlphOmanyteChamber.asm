...
RuinsOfAlphOmanyteChamberSkip:
	refreshscreen
	writetext RuinsOfAlphOmanyteChamberSkipText
	yesorno
	iftrue .PuzzleSkip
	closetext
	end
...
RuinsOfAlphOmanyteChamberSkipText:
	text "Skip puzzle?"
	done
...
RuinsOfAlphOmanyteChamber_MapEvents:
	...
	bg_event  5,  3, BGEVENT_RIGHT, RuinsOfAlphOmanyteChamberSkip
