DEF CELADONGAMECORNERPRIZEROOM_TM32_COINS     EQU 2000 ;Thunder 25
DEF CELADONGAMECORNERPRIZEROOM_TM29_COINS     EQU 2000 ;Blizzard 14
DEF CELADONGAMECORNERPRIZEROOM_TM15_COINS     EQU 2000 ;Fire Blast 18
DEF CELADONGAMECORNERPRIZEROOM_PIKACHU_COINS  EQU 1000 ;BULBASAUR
DEF CELADONGAMECORNERPRIZEROOM_PORYGON_COINS  EQU 1000 ;CHARMANDER
DEF CELADONGAMECORNERPRIZEROOM_LARVITAR_COINS EQU 1000 ;SQUIRTLE
