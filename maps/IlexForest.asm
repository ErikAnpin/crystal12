...
IlexForest_MapEvents:
	...
	def_object_events
	object_event 14, 31, SPRITE_FARFETCHD_OW, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, IlexForestFarfetchdScript, EVENT_ILEX_FOREST_FARFETCHD
