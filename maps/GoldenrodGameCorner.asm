...
DEF GOLDENRODGAMECORNER_TM14_COINS      EQU 1500 ;Psychic
DEF GOLDENRODGAMECORNER_TM38_COINS      EQU 2500 ;Hyper Beam
DEF GOLDENRODGAMECORNER_ABRA_COINS      EQU 222  ;Abra
DEF GOLDENRODGAMECORNER_CUBONE_COINS    EQU 678  ;Porygon
DEF GOLDENRODGAMECORNER_WOBBUFFET_COINS EQU 1111 ;Snorlax
