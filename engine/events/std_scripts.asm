...
InitializeEventsScript:
	...
	setevent EVENT_ROUTE20_ARTICUNO
	setevent EVENT_FOUGHT_ARTICUNO
	setevent EVENT_ROUTE10_ZAPDOS
	setevent EVENT_FOUGHT_ZAPDOS
	setevent EVENT_VICTORYROAD_MOLTRES
	setevent EVENT_FOUGHT_MOLTRES
	setevent EVENT_VERMILIONPORT_MEW
	setevent EVENT_FOUGHT_MEW
	setevent EVENT_BEAT_RED	
	setevent EVENT_SILVERCAVE_MEWTWO
