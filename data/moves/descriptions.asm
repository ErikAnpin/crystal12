...
StompDescription:
	db   "Stomps the target"
	next "with a big foot.@"
...
TakeDownDescription:
	db   "A dragon's charge"
	next "attack.@"

ThrashDescription:
	db   "Attack for 3 turns"
