...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLESLAP,   EFFECT_DOUBLE_HIT,         40, NORMAL,        95, 15,   0
	...
	move VICEGRIP,     EFFECT_NORMAL_HIT,         90, NORMAL,       100, 30,   0
	...
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         70, FIGHTING,      90, 15,  30
	move SAND_ATTACK,  EFFECT_ACCURACY_DOWN,       0, GROUND,       100, 15,   0
	move HEADBUTT,     EFFECT_FLINCH_HIT,         60, NORMAL,       100, 15,  20
	...
	move TAKE_DOWN,    EFFECT_RECOIL_HIT,         90, NORMAL,        95, 20,   0
	...
	move ACID,         EFFECT_BURN_HIT,           65, POISON,       100, 15,  10
	move EMBER,        EFFECT_BURN_HIT,           40, FIRE,         100, 25,  10
	move FLAMETHROWER, EFFECT_BURN_HIT,           90, FIRE,         100, 10,  10
	move MIST,         EFFECT_MIST,                0, ICE,          100, 30,   0
	move WATER_GUN,    EFFECT_NORMAL_HIT,         40, WATER,        100, 25,   0
	move HYDRO_PUMP,   EFFECT_NORMAL_HIT,        110, WATER,         85,  5,  10
	move SURF,         EFFECT_NORMAL_HIT,         90, WATER,        100, 10,   0
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         90, ICE,          100, 10,  10
	move BLIZZARD,     EFFECT_FREEZE_HIT,        110, ICE,           85,  5,  10
	move PSYBEAM,      EFFECT_CONFUSE_HIT,        65, PSYCHIC_TYPE, 100, 15,  10
	move BUBBLEBEAM,   EFFECT_SPEED_DOWN_HIT,     65, WATER,        100, 15,  10
	...
	move LOW_KICK,     EFFECT_FLINCH_HIT,         60, FIGHTING,     100, 20,  30
	move COUNTER,      EFFECT_COUNTER,             1, FIGHTING,     100, 20,   0
	move SEISMIC_TOSS, EFFECT_LEVEL_DAMAGE,        1, FIGHTING,     100, 20,   0
	move STRENGTH,     EFFECT_ATTACK_UP_HIT,      80, NORMAL,       100, 15,  10
	...
	move THUNDERBOLT,  EFFECT_PARALYZE_HIT,       90, ELECTRIC,     100, 10,  10
	move THUNDER_WAVE, EFFECT_PARALYZE,            0, ELECTRIC,      90, 20,   0
	move THUNDER,      EFFECT_THUNDER,           110, ELECTRIC,      85,  5,  30
	...
	move LICK,         EFFECT_PARALYZE_HIT,       35, GHOST,        100, 30,  20
	move SMOG,         EFFECT_POISON_HIT,         35, POISON,       100, 20,  20
	move SLUDGE,       EFFECT_POISON_HIT,         65, POISON,       100, 15,  30
	move BONE_CLUB,    EFFECT_FLINCH_HIT,         85, GROUND,        90, 20,  10
	move FIRE_BLAST,   EFFECT_BURN_HIT,          110, FIRE,          85,  5,  10
	move WATERFALL,    EFFECT_FLINCH_HIT,         80, WATER,        100, 15,  20
	move CLAMP,        EFFECT_FLINCH_HIT,         65, WATER,        100, 15,  30
	...
	move POISON_GAS,   EFFECT_POISON,              0, POISON,        95, 40,   0
	...
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        120, WATER,         95, 10,   0
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  60, GROUND,       100, 10,  20
	...
	move SPARK,        EFFECT_PARALYZE_HIT,       65, ELECTRIC,     100, 15,  30
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       80, DRAGON,       100, 20,  20
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  110, STEEL,         85, 15,  10
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      65, STEEL,         95, 15,  30
