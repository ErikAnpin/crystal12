...
.Shore_Good:
	db  35 percent + 1, SHELLDER,   20
	db  70 percent + 1, STARYU,     20
...
.Ocean_Old:
	db  40 percent,     CHINCHOU,   10
	db  80 percent,     QWILFISH,   10
	db 100 percent,     HORSEA,     10
.Ocean_Good:
	db  35 percent + 1, CHINCHOU,   20
	db  70 percent + 1, QWILFISH,   20
	db  90 percent + 1, HORSEA,     20
	db 100 percent,     time_group 2
.Ocean_Super:
	db  40 percent,     LANTURN,    40
	db  70 percent + 1, time_group 3
	db  90 percent + 1, QWILFISH,   40
	db 100 percent,     TENTACRUEL, 40

.Lake_Old:
	db  40 percent,     MAGIKARP,   10
	db  80 percent,     GOLDEEN,    10
	db 100 percent,     REMORAID,   10
.Lake_Good:
	db  35 percent + 1, MAGIKARP,   20
	db  70 percent + 1, GOLDEEN,    20
	db  90 percent + 1, REMORAID,   20
	db 100 percent,     time_group 4
.Lake_Super:
	db  40 percent,     SEAKING,    40
	db  70 percent + 1, time_group 5
...
.Dratini_Super:
	db  20 percent,     MAGIKARP,   40
	db  40 percent,     time_group 9
	db  60 percent,     GYARADOS,   40
	db 100 percent,     DRAGONAIR,  40

.Qwilfish_Swarm_Old:
	db  20 percent,     MAGIKARP,   5
	db  40 percent,     MAGIKARP,   5
	db 100 percent,     QWILFISH,   5
.Qwilfish_Swarm_Good:
	db  20 percent,     MAGIKARP,   20
	db  40 percent,     QWILFISH,   20
	db  90 percent + 1, QWILFISH,   20
	db 100 percent,     time_group 10
.Qwilfish_Swarm_Super:
	db  20 percent,     QWILFISH,   40
	db  40 percent,     time_group 11
	db  90 percent + 1, QWILFISH,   40
...
.Remoraid_Swarm_Super:
	db  20 percent,     REMORAID,   40
	db  40 percent,     time_group 13
...
.Dratini_2_Super:
	db  20 percent,     MAGIKARP,   10
	db  40 percent,     time_group 17
	db  50 percent + 1, MAGIKARP,   10
	db 100 percent,     DRAGONAIR,  10

.WhirlIslands_Old:
	db  20 percent,     MAGIKARP,   10
	db  80 percent,     HORSEA,     10
	db 100 percent,     DRATINI,    10
.WhirlIslands_Good:
	db  20 percent,     MAGIKARP,   20
	db  70 percent + 1, HORSEA,     20
	db  90 percent + 1, DRATINI,    20
	db 100 percent,     time_group 18
.WhirlIslands_Super:
	db  20 percent,     KRABBY,     40
	db  70 percent + 1, time_group 19
...
.Qwilfish_Super:
	db  20 percent,     TENTACOOL,  40
	db  40 percent,     time_group 21
	db  90 percent + 1, QWILFISH,   40
	db 100 percent,     GYARADOS,   40

.Remoraid_Old:
	db  20 percent,     MAGIKARP,   10
	db  40 percent,     POLIWAG,    10
	db 100 percent,     REMORAID,   10
.Remoraid_Good:
	db  20 percent,     MAGIKARP,   20
	db  40 percent,     POLIWAG,    20
	db  90 percent + 1, REMORAID,   20
	db 100 percent,     time_group 6
.Remoraid_Super:
	db  20 percent,     POLIWAG,    40
	db  40 percent,     time_group 7
	db  90 percent + 1, MAGIKARP,   40
	db 100 percent,     REMORAID,   40
