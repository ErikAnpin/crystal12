...
.Dratini_Super:
	...
	db  60 percent + 1, GYARADOS,   40
	db 100 percent,     DRAGONAIR,  40

.Qwilfish_Swarm_Old:
	db  20 percent + 1, MAGIKARP,   5
	db  40 percent + 1, MAGIKARP,   5
